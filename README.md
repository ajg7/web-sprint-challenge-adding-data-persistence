...
Relational Database is a database that can mangage and store data as well as form relationships between data. SQL is a querying language that allows use to query data in a Relational Database

2. Why do tables need a `primary key`?

Primary Key allows us to access specific data, and allows other tables to access it
...
You need to have a foreign key and your primary key needs to be given to other tables
